        ...
        <Link to="/" className="flex items-center gap-3 group" onClick={() => setMobileOpen(false)}>
          ...
          <div className="flex flex-col leading-none">
            <span
              ...
              style={{ textShadow: "0 0 20px rgba(0,212,255,0.6), 0 0 40px rgba(0,212,255,0.3)" }}
            >
              Xevorith
            </span>
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            >
              <div className="flex h-full flex-col">
                <div className="flex items-center justify-between border-b px-5 py-4" style={{ borderColor: "rgba(0,212,255,0.12)" }}>
                  <div className="flex items-center gap-2">
                    <Cpu className="size-5 text-[#00d4ff]" style={{ filter: "drop-shadow(0 0 6px rgba(0,212,255,0.7))" }} />
                    <span className="font-display text-base font-bold text-white">Xevorith</span>
                  </div>
                  <SheetClose asChild>
                ...
                <nav className="flex flex-col gap-1 px-3 py-4">
                  {navItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        <Icon className={cn("size-4 shrink-0", isActive ? "text-[#00d4ff]" : "text-white/40")} />
                        {item.label}
                        {isActive && <span className="ml-auto size-1.5 rounded-full bg-[#00d4ff] animate-pulse" />}
                      </Link>
                    );
                  })}
                </nav>

                <div className="mt-auto border-t px-4 py-4" style={{ borderColor: "rgba(0,212,255,0.12)" }}>
